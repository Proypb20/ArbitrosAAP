...
<title>Asociacion Argentina de Paintball | Sitio Oficial de AAP | Crear Categorias</title>
</head>
<body>
...
<c:choose>
   ...
   <frm:form action="GuardarCategoria.html" method="post" >
		<table>
			<tr>
				<td align="left">Nombre de categoria</td>
				<td><frm:input name="nombre" id="nombre" class="input" value=""
						size="25" type="text" path="nombre" /></td>
			</tr>
			<tr>
				<td align="left">Honorarios</td>
				<td><frm:input name="honorarios" id="honorarios" class="input" value=""
